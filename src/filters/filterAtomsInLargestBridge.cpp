/**********************************************************************
filterAtomsInLargestBridge.cpp - Sieve
...
FilterAtomsInLargestBridge::FilterAtomsInLargestBridge(void)
{
   _keyword = "ATOMS_IN_LARGEST_BRIDGE";
}
...
FilterAtomsInLargestBridge::FilterAtomsInLargestBridge(const FilterAtomsInLargestBridge& f)
{
...
FilterAtomsInLargestBridge&
FilterAtomsInLargestBridge::operator=(const FilterAtomsInLargestBridge& f)
{
   // Filter class members
   _initialised = f._initialised;
   _whiteSpace = f._whiteSpace;
...
void
FilterAtomsInLargestBridge::Calculate(OpenBabel::OBMol* mol)
{
   // Are there rings?
