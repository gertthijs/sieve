/**********************************************************************
filterAtomsInLargestSidechain.cpp - Sieve
...
FilterAtomsInLargestSidechain::FilterAtomsInLargestSidechain(void)
{
   _keyword = "ATOMS_IN_LARGEST_SIDECHAIN";
}
...
FilterAtomsInLargestSidechain::FilterAtomsInLargestSidechain(const FilterAtomsInLargestSidechain& f)
{
...
FilterAtomsInLargestSidechain&
FilterAtomsInLargestSidechain::operator=(const FilterAtomsInLargestSidechain& f)
{
   // Filter class members
   _initialised = f._initialised;
   _whiteSpace = f._whiteSpace;
...
void
FilterAtomsInLargestSidechain::Calculate(OpenBabel::OBMol* mol)
{
   // Rings?
   bool rings(false);
