/**********************************************************************
filterAromaticRingFraction.cpp - Sieve
...
FilterAromaticRingFraction::FilterAromaticRingFraction(void)
{
   _keyword = "AROMATIC_RING_FRACTION";
}
...
FilterAromaticRingFraction::FilterAromaticRingFraction(const FilterAromaticRingFraction& f)
{
...
FilterAromaticRingFraction&
FilterAromaticRingFraction::operator=(const FilterAromaticRingFraction& f)
{
   // Filter class members
   _initialised = f._initialised;
   _whiteSpace = f._whiteSpace;
...
void
FilterAromaticRingFraction::Calculate(OpenBabel::OBMol* mol)
{
