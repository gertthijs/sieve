/**********************************************************************
filterAtomsInSmallestBridge.cpp - Sieve
...
FilterAtomsInSmallestBridge::FilterAtomsInSmallestBridge(void)
{
   _keyword = "ATOMS_IN_SMALLEST_BRIDGE";
}
...
FilterAtomsInSmallestBridge::FilterAtomsInSmallestBridge(const FilterAtomsInSmallestBridge& f)
{
...
FilterAtomsInSmallestBridge&
FilterAtomsInSmallestBridge::operator=(const FilterAtomsInSmallestBridge& f)
{
   // Filter class members
   _initialised = f._initialised;
   _whiteSpace = f._whiteSpace;
