/**********************************************************************
filterBridgeFraction.cpp - Sieve
...
FilterBridgeFraction::FilterBridgeFraction(void)
{
   _keyword = "BRIDGE_FRACTION";
}
...
FilterBridgeFraction::FilterBridgeFraction(const FilterBridgeFraction& f)
{
...
FilterBridgeFraction&
FilterBridgeFraction::operator=(const FilterBridgeFraction& f)
{
   // Filter class members
   _initialised = f._initialised;
   _whiteSpace = f._whiteSpace;
